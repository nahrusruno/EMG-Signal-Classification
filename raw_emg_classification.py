...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 14:32:04 2021
...
class LSTM_Classifier:
    ...
    def __init__(self, X, y, first_layer_neurons, second_layer_neurons, nb_epoch = 50, batch_size = 100):
        self.X = X
        self.y = y
        self.first_layer_neurons = first_layer_neurons
        self.second_layer_neurons = second_layer_neurons
        self.input_dimension = X.shape[1]
        self.number_of_classes = y.nunique().values
...
### FROM FEATURE_EXT SCRIPT

data_class = preprocessor(get_csv())
resultant_df = data_class.concatingDataframe('interpolated_filtered')
pd.load(resultant_df)
